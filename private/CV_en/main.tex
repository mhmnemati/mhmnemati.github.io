...
As an experienced DevOps Engineer with a Master's in Computer Science from the University of Tehran, I specialize in high-performance computing, infrastructure as code, and CI/CD automation. I have worked with leading companies like Visiwise.co and Smartech, where I designed and maintained robust infrastructure solutions.
...
\begin{section}{Education}
 \begin{subsectionnobullet}{M.Sc in Computer Science}{University of Tehran}{Sep 2021 -- Aug 2024}{Teharn, Iran}
     \item Graduated with advanced coursework in fields such as Digital Image Processing and Natural Language Processing, and a thesis on seizure detection from multi-channel EEG using Graph Neural Networks.
 \end{subsectionnobullet}
 \begin{subsectionnobullet}{B.Sc in Computer Science}{Kharazmi University}{Sep 2016 -- Jan 2021}{Tehran, Iran}
     \item Graduated with strong academic performance, excelling in key courses such as Artificial Intelligence, Computer Graphics, and Operating Systems.
 \end{subsectionnobullet}
\end{section}
